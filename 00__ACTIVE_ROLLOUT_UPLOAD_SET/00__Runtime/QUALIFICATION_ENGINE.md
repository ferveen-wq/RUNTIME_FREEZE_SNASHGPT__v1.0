...
AND vehicle_year is present:
  ...
  #
  # PHASE3A_Q_CERAMIC_GOAL -> set CERAMIC_GOAL =
  #   EASY_CLEAN_LONG_TERM | LOOKS_FRESH_SHORT_TERM | UNKNOWN
  #
  # PHASE3A_Q_CERAMIC_WASH_PATTERN -> set CERAMIC_WASH_PATTERN =
  #   BUCKET_LOCALITY | AUTO_TUNNEL | WATERLESS_MALL | PRO_WASH_CENTER | MIXED | UNKNOWN
  #
