...
## BROWSING_GENERIC + MISSING VEHICLE DETAILS (HARD)
...
- Include ONLY:
  1) L.2 BROWSING_GENERIC — SERVICE OVERVIEW (NO BULLETS)
  2) L.1 QUALIFICATION CLARIFIERS (VEHICLE DETAILS) — choose variant by missing_info_ask_count (V1/V2/V3)
- Output MUST contain exactly 1 question total (the model/year question).
- Do NOT ask preference questions (no “what do you want to improve/protect”).
- Suppress hooks, preferences, education, and upsell blocks until QUALIFICATION_STATUS = READY.
- No acknowledgement lines before the question (no “Got it”, “Understood”, “Perfect”, “Thanks”).
---
...
IF request_type == PRICE_RESISTANCE AND missing_fields is empty:
- Use PRICE_LADDER_ENGINE.md output (pricing allowed ONLY inside that engine’s constraints).
