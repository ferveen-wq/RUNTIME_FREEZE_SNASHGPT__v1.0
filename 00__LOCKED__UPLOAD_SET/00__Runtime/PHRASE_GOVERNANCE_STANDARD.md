...
EDUCATION SNIPPET STRUCTURE RULE

All Phase7 education snippets must include a return anchor.
...
Education must reconnect the conversation to
Phase5 narrowing or decision support.

Education snippets must never end without a
guiding question or decision anchor.
