...
## CERAMIC — PHASE_0_2_MIN
EN: Ceramic coating is a protective coating applied to painted surfaces to help with gloss, easier washing, and resistance to light stains.

To guide you properly, what’s the car model and year?
AR: السيراميك هو طبقة حماية تُركّب على الطلاء للمساعدة باللمعة وسهولة الغسيل ومقاومة بعض البقع الخفيفة.

عشان أوجّهك صح، شنو موديل السيارة وأي سنة؟

---

## TINT — PHASE_0_2_MIN
EN: Window tint is a film applied to the glass to reduce heat and glare and improve comfort and privacy.

Do you want tint for all windows or specific ones only?
AR: التظليل هو فيلم يُركّب على الزجاج لتقليل الحرارة والوهج وزيادة الراحة والخصوصية.

تحب تظليل كامل للسيارة، أو نوافذ محددة فقط؟

---

## POLISHING — PHASE_0_2_MIN
Definition:
Polishing is a paint correction process that improves surface clarity.

Purpose:
It helps reduce swirl marks and light surface imperfections.

Qualification Pivot:
Vehicle condition and intent must be clarified before recommendation.
...
Would you like me to check the price, or do you prefer a quick visit first?
AR: تمام. تم تسجيل طلبك.

تحب أشيّك لك على السعر، أو تفضل تمر علينا زيارة سريعة أول؟
...
### PHASE_0_2_MIN
EN: Ceramic coating is a protective layer on the paint that improves gloss and makes washing easier.

To guide you properly, what’s the car model and year?
AR: السيراميك هو طبقة حماية على الطلاء تزيد اللمعة وتسهّل الغسيل.
...
### PHASE_0_2_MIN
Graphene is a premium coating option similar to ceramic, focused on gloss and easier cleaning.
الجرافين خيار طلاء حماية أعلى من السيراميك، يركّز على اللمعة وتسهيل التنظيف.
...
### PHASE_0_2_MIN
Interior ceramic protection is a coating for interior surfaces to help reduce staining and make cleaning easier.
حماية السيراميك الداخلية هي طبقة على بعض الأسطح الداخلية لتقليل البقع وتسهيل التنظيف.
...
### PHASE_0_2_MIN
Polishing is paint correction that reduces swirl marks and restores gloss before protection.
التلميع هو تصحيح للطلاء يقلل الهالات والخدوش الخفيفة ويرجّع اللمعة قبل الحماية.
...
### PHASE_0_2_MIN
Wrap is a vinyl film applied to change the car’s color/finish and protect the paint lightly.
الـ Wrap هو فيلم فينيل لتغيير لون/شكل السيارة مع حماية خفيفة للطلاء.
