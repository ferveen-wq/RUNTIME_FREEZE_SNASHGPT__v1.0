# PRICE_TABLE_VAT_INCL.md (LOCKED)
- VAT included
- Prices are base (discount/bundle engines come later)
- Currency: (as per your business standard)
...
| GLOBAL_MATTE_FRONT_10Y | 350 | 450 | 525 |
...
| SKU | VCB_1 | VCB_2 | VCB_3 |
|---|---:|---:|---:|
| ROOF_PPF_BLACK_GLOSS | 60 | 90 | 130 |
