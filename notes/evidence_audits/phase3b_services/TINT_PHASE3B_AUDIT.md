...
### Readiness gate
- Phase 3B readiness for TINT is defined in PHASE3A_QUALIFICATION_DECISION_MATRIX.md:
...
- For TINT price-ready path:
  - PHASE3B_TINT_RANGE is the mapped phrase block
- runner/context_reset_prompt.txt hardens the TINT price-ready path:
  - selected_phrase_id MUST equal PHASE3B_TINT_RANGE
...
- No additional git recovery required for this first TINT Phase 3B pass
...
- rendered through PHASE4_8_MESSAGE_ASSEMBLY_MAP.md using PHASE3B_TINT_RANGE for the tint price-ready path
